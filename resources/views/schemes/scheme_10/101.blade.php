...
/>
</div><div    wire:key="field-norm-age">
    <x-form.input
    type="text"
    name="age"
    label="Age"
...
<div class="grid md:grid-cols-3 gap-4 mt-4">
<div    wire:key="field-norm-ben_father_name">
    <x-form.input
    type="text"
...
</div><div    wire:key="field-norm-ben_mother_name">
    <x-form.input
    type="text"
...
/>
</div><div    wire:key="field-norm-caste">
    <x-form.select
    name="caste"
    label="Caste"
    data-wire="caste"
